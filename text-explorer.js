...
while (!(x === 4 && y === 3)) {
	...
	if (
		...
		console.log(
			`You are in Red Plains. Tall red grass waves in the wind. 
            Your coordinates are ( ${x} , ${y} ). 
            Would you like to go "up", "right", "down", or "left"? `
		);
		direction = prompt("> ");
	...
	if (
		...
		console.log(
			`You are in Endless Desert. Hot and vast, sure wish you had brought water.  
            Your coordinates are ( ${x} , ${y} ). 
            Would you like to go "up", "right", "down", or "left"? `
		);
		direction = prompt("> ");
	...
	if (
		...
		console.log(
			`You have entered a Green Meadow. There is green grass everywhere. 
            Your coordinates are ( ${x} , ${y} ). 
            Would you like to go "up", "right", "down", or "left"? `
		);
		direction = prompt("> ");
	...
	if (
		...
		console.log(
			`You have entered a Golden Meadow. There is golden grass everywhere. 
            Your coordinates are ( ${x} , ${y} ). 
            Would you like to go "up", "right", "down", or "left"? `
		);
		direction = prompt("> ");
	...
	if (
		...
		console.log(
			`You enter a River Run. A flowing river greets you, running south to north. 
	...
	if (
		...
		console.log(
			`You have entered a Dark Forest. Forboding and Dark. 
            Your coordinates are ( ${x} , ${y} ). 
            Would you like to go "up", "right", "down", or "left"? `
		);
		direction = prompt("> ");
	...
	if (
		...
		console.log(
			`You enter a Troll Cave. You do not want to be here.
            You cannot proceed any further right! 
            Your coordinates are ( ${x} , ${y} ). 
            Would you like to go "up", "left", or "down"? `
		);
	...
	if (x > 10 || y > 10 || x < -10 || y < -10) {
		console.log(`You have exceeded the boundaries of this game! Please retry!`);
		x = 0;
		y = 0;
		console.log(
			`You are in town. Head in any direction to explore the world. 
